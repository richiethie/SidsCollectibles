...
export default function AboutPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-yellow-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          <div className="flex items-center space-x-2 text-xs sm:text-sm text-blue-600 mb-3 sm:mb-4">
            <Link href="/" className="hover:text-purple-700 transition-colors">Home</Link>
            <span>/</span>
            <span className="text-blue-900">About</span>
          </div>
          <h1 className="text-2xl md:text-3xl font-bold text-purple-700">About SidsCollectibles</h1>
          <p className="text-base md:text-lg text-blue-700 mt-2">Jeremiah 29:11 "For I know the plans I have for you..."</p>
        </div>
      </div>

      {/* Main Content */}
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
        <div className="bg-white rounded-xl shadow-lg border border-purple-100 p-4 sm:p-6 md:p-8">
          {/* Tagline */}
          <div className="text-center mb-8">
            <div className="inline-flex items-center px-3 sm:px-4 py-2 bg-blue-50 text-blue-700 text-xs sm:text-sm md:text-base font-medium rounded-full mb-4 sm:mb-6 border border-blue-200 max-w-full">
              <svg className="w-5 h-5 text-purple-700 mr-2" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
          ...
          <section className="mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-purple-700 mb-4 sm:mb-6 text-left flex items-center gap-2">
            ...
            <div className="space-y-4 sm:space-y-6 text-blue-900">
              ...
              <p className="leading-relaxed text-sm sm:text-base font-semibold text-blue-800 text-left">
          ...
          <section className="mb-8 sm:mb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 sm:p-6 flex flex-col justify-between min-h-[180px]">
  <h3 className="text-lg sm:text-xl font-bold text-blue-900 mb-3 sm:mb-4 text-left flex items-center gap-2">
    <svg className="w-5 h-5 text-purple-700" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18m6-9H6" />
    </svg>
    Our Mission
  </h3>
  <span className="block text-blue-700 text-base sm:text-lg md:text-xl font-semibold mb-2">
  ...
  <p className="text-blue-800 leading-relaxed text-base sm:text-lg md:text-xl font-semibold text-left">
    {/* Additional mission details can go here if needed */}
  </p>
</div>
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 sm:p-6 min-h-[180px] flex flex-col justify-between">
                <h3 className="text-lg sm:text-xl font-bold text-yellow-900 mb-3 sm:mb-4 text-left flex items-center gap-2">
                ...
                <p className="text-yellow-800 leading-relaxed text-sm sm:text-base text-left">
                  To demonstrate the light of Christ in a dark world. To boldly share our faith while serving others. To remember what is truly important, "God, Family, Country" in that order. Pokemon has brought my family closer together, closer to God, and has filled us with so much joy! Our vision is to share that Love, Peace, and Joy throughout Pokemon in the hopes that others may know intimately the great and loving God that has created all of us with such care and detail.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="text-left sm:text-center">
                <div className="flex items-start space-x-3 sm:flex-col sm:space-x-0 sm:space-y-3 sm:items-center">
                  <div className="w-8 h-8 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-purple-100 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-6 h-6 sm:w-8 sm:h-8 text-purple-700" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18m6-9H6" />
                    </svg>
                  </div>
                  <div className="flex-1 sm:text-center">
                    <h3 className="text-lg sm:text-xl font-bold text-purple-700 mb-2 text-left sm:text-center">Faith-Based</h3>
                    <p className="text-purple-800 leading-relaxed text-sm md:px-2 text-left sm:text-center">
                      Our business is built on Christian values of honesty, integrity, and genuine care for others. 
                      <span className="block mt-2 text-xs text-purple-600 italic">"Do to others as you would have them do to you." (Luke 6:31)</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="text-left sm:text-center">
                <div className="flex items-start space-x-3 sm:flex-col sm:space-x-0 sm:space-y-3 sm:items-center">
                  ...
                  <div className="flex-1 sm:text-center">
                    <h3 className="text-lg sm:text-xl font-bold text-blue-700 mb-2 text-left sm:text-center">Excellence</h3>
                    <p className="text-blue-800 leading-relaxed text-sm md:px-2 text-left sm:text-center">
              ...
              <div className="text-left sm:text-center">
                <div className="flex items-start space-x-3 sm:flex-col sm:space-x-0 sm:space-y-3 sm:items-center">
                  ...
                  <div className="flex-1 sm:text-center">
                    <h3 className="text-lg sm:text-xl font-bold text-green-700 mb-2 text-left sm:text-center">Authenticity</h3>
                    <p className="text-green-800 leading-relaxed text-sm md:px-2 text-left sm:text-center">
              ...
              <div className="text-left sm:text-center">
                <div className="flex items-start space-x-3 sm:flex-col sm:space-x-0 sm:space-y-3 sm:items-center">
                  ...
                  <div className="flex-1 sm:text-center">
                    <h3 className="text-lg sm:text-xl font-bold text-yellow-700 mb-2 text-left sm:text-center">Community</h3>
                    <p className="text-yellow-800 leading-relaxed text-sm md:px-2 text-left sm:text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              <div className="space-y-4">
                <div className="flex items-start space-x-3 text-left">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl font-bold text-blue-700 mb-2">Years of Experience</h3>
                ...
                <div className="flex items-start space-x-3 text-left">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl font-bold text-purple-700 mb-2">Professional Restoration</h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3 text-left">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl font-bold text-green-700 mb-2">Expert Authentication</h3>
                ...
                <div className="flex items-start space-x-3 text-left">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg sm:text-xl font-bold text-yellow-700 mb-2">Personal Dedication</h3>
          ...
          <section>
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl p-4 sm:p-6 md:p-8">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-purple-700 mb-3 sm:mb-4 text-left flex items-center gap-2">
                <svg className="w-6 h-6 text-purple-700" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18m6-9H6" />
                </svg>
                A Personal Thank You
              </h2>
              <p className="text-blue-900 leading-relaxed text-sm sm:text-base mb-4 text-left">
              ...
              <p className="text-blue-900 leading-relaxed text-sm sm:text-base font-medium text-left">
              ...
              <div className="mt-4 sm:mt-6 text-left flex items-center gap-2">
                <svg className="w-5 h-5 text-purple-700" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18m6-9H6" />
                </svg>
                <p className="text-purple-700 font-semibold text-sm sm:text-base">- Sid, Founder of SidsCollectibles</p>
              </div>
            </div>
          </section>
        </div>
